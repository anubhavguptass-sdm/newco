(function($) {
  ...
  function validateForm(type) {
    ...
    if (type == 'country' || type == 'all') {
      if (country == '') {
        document.getElementById('00N9E000004hkmw').style.cssText =
          'border-color: #c30000; outline: 1px solid #c30000';
    ...
    if (type == 'subject' || type == 'all') {
      if (enquiry == '') {
        document.getElementById('subject').style.cssText =
          'border-color: #c30000; outline: 1px solid #c30000';
  ...
  function ValidateEmail() {
    ...
    if (document.haleonForm.email.value.match(mailformat)) {
      ClearForm();
      document.haleonForm.retURL.value =
        'https://haleon-com.preprod-cf65.ch.adobecqms.net/contact-us/thank-you';
      document.haleonForm.action =
        'https://crms--crmssit.my.salesforce.com/servlet/servlet.WebToCase?encoding=UTF-8';
      return true;
    } else {
      event.preventDefault();
      document.haleonForm.email.focus();
